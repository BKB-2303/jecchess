    ...
    <Router>
      <Routes>
        <Route
          path="/"
          element={isZooming ? (
            <div className="fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-gradient-to-r  from-slate-800 to-stone-950/95 backdrop-blur">
              <img
                src={KnightGambit2} 
                alt="Zooming Image"
